...
<head>
  ...
  <title>Personal Manager - Dashboard</title>
...
<body>
  ...
  <div class="d-flex" id="wrapper" background-color="darksalmon">

    <!-- Sidebar -->
    <div class="border-right" id="sidebar-wrapper">
      <div class="user" background-color="blue">
      ...
      <div class="list-group list-group-flush">
        <div style="background-color: blue">;<a href="index.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="home"></span> Dashboard</a></div>
         <div style="background-color: blue">;<a href="add_expense.php" class="list-group-item list-group-item-action "><span data-feather="plus-square"></span> Add Expenses</a></div>
         <div style="background-color: blue">;<a href="manage_expense.php" class="list-group-item list-group-item-action "><span>(Ksh)</span> Manage Expenses</a></div>
      </div>
       <div style="background-color: darkmagenta">;<div class="sidebar-heading">Settings </div>
      <div class="list-group list-group-flush"></div>
         <div style="background-color: darkmagenta">; <a href="profile.php" class="list-group-item list-group-item-action "><span data-feather="user"></span> Profile</a></div>
         <div style="background-color: darkmagenta">;<a href="logout.php" class="list-group-item list-group-item-action "><span data-feather="power"></span> Logout</a></div></div>
...
<div style="background-color: blue">;
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md">
            <div class="card">
              <div style="color:darksalmon;"><div class="card-header">
          ...
          <div class="col-md">
            <div class="card">
              ...
              <div class="card-body">
                <canvas id="expense_category_pie" height="150"></canvas></div>
              </div>
            </div>
          </div>
        </div>
