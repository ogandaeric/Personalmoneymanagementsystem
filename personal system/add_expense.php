...
<head>
    ...
    <title>Personal Manager Manager - Dashboard</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="manage_expense.php" class="list-group-item list-group-item-action"><span>(Ksh)</span> Manage Expenses</a>
            </div></div>
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Amount(Ksh)</b></label>
                                <div class="col-md-6">
