    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="manage_expense.php" class="list-group-item list-group-item-action sidebar-active">(Ksh)Manage Expenses</a>
            </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td>Ksh<?php echo $row['expensedate']; ?></td>
                                    <td><?php echo 'Ksh'.$row['expense']; ?></td>
